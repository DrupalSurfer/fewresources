  ...
  <ul>
    <li>
      ...
      <fieldset class="radio btn-group toolcol-showblocktitle">
        <input type="radio" id="toggleShowBlockTitle0" class="toolbox-toggle" data-action="showBlockTitle" name="toggleShowBlockTitle" value="0" checked="checked"/>
        <label for="toggleShowBlockTitle0"><?php print t('No') ?></label>
        <input type="radio" id="toggleShowBlockTitle1" class="toolbox-toggle" data-action="showBlockTitle" name="toggleShowBlockTitle" value="1"/>
